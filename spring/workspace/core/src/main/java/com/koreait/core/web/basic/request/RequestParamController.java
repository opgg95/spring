...
public class RequestParamController {
	...
	// 반환 타입이 없고, 응답에 값을 직접 넣으면 , view 조회X
	...
	/*
	 *  @ResponseBody
	 *   - view 조회를 무시하고 HTTP massage body에 직접 내용을 할당
	 *  @RequestParam
	 *  - 파라미터 이름으로 바인딩
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping("/model-attribute-v1") public String
	 * modelAttributeV1(@RequestParam String username, @RequestParam int age) {
	 * 
	 * HelloData helloData = new HelloData(); helloData.setUsername(username);
	...
	// 사용 후 
	  ...
	  @ResponseBody
	  @RequestMapping("/model-attribute-v1") public String
	  modelAttributeV1(@ModelAttribute HelloData helloData) {
