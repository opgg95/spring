...
<body>
	...
	<div class="container col" style="margin-bottom: 300px;">
		...
		<div class="grid text-center mb-5">
			...
			<!-- 공지사항테이블 -->
		<form action="${pageContext.request.contextPath}/board/BoardWriteOk.mc" method="post" name="boardForm">
		...
		<div class="text-end">
			<table style="border: 0px;">
				<tr align="right" valign="middle">
					...
					<!-- 목록 : boardlist.jsp --> 
					<a href="${pageContext.request.contextPath}/board/Boardlist.mc"
					class="btn btn-success">목록</a> 
					
					<a href="${pageContext.request.contextPath}/board/BoardModify.mc?boardnum=${board.boardnum }" class="btn btn-secondary" >수정</a>
					
									
					<a href="javascript:deleteboard(${board.boardnum })" class="btn btn-danger">삭제</a>
										
					<a href="${pageContext.request.contextPath}/board/BoardWrite.mc" class="btn btn-primary">글쓰기</a>
...
function boardModify(boardnum){
	document.boardForm.action = "${pageContext.request.contextPath}/board/BoardModify.mc?boardnum="+boardnum;
...
function deleteboard(boardnum){
	...
	document.boardForm.action = "${pageContext.request.contextPath}/board/DeleteBoard.mc?boardnum="+boardnum;
	document.boardForm.submit();
