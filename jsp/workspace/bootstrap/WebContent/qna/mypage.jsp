	...
	<div class="container border bg-primary bg-opacity-75 rounded" style="margin-bottom:300px;">
		...
		<div class="row py-5 ">
			...
			<div class="col-3 text-center">
				...
				<p class="mt-2">
					<a href="#" class="text-decoration-none text-white" data-bs-toggle="modal" data-bs-target="#coupon">쿠폰확인</a>
				</p>
			</div>
			<div class="col-3 text-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
				...
				<p class="mt-2">
					<a href="#" class="text-decoration-none text-white">마일리지</a>
				</p>
			</div>
			<div class="col-3 text-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
				...
				<p class="mt-2">
					<a href="#" class="text-decoration-none text-white">예약현황</a>
				</p>
			</div>
		</div>
						...
						<form class="">
							<div class="form-floating mb-3">
								<input type="password" class="form-control rounded-4"
									id="floatingPassword" placeholder="password" disabled> <label
				...
				<div class="modal-content">
					...
					<div class="modal-body p-5 pt-0">
						...
						<p class="text-black-50 mt-5">
							* 쿠폰 등록후 기간, 혜택 등을 꼭 확인하세요.<br>
							* 쿠폰 번호 등록 시, 하이폰 (-)은 안 넣으셔도 됩니다.<br>
							* 알파벳 O와 숫자 0을 명확히 구분하여 입력하세요.
						</p>
					</div>
				</div>
			</div>
