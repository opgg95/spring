...
<div class="container col" style="margin-bottom: 300px;">
	...
	<div class="text-end">
		...
		<a href="border.jsp" class="btn btn-success">목록</a> <a
			class="btn btn-secondary">수정</a> <a class="btn btn-danger">삭제</a> <a
			href="BorderWrite.jsp" class="btn btn-primary pull-right">글쓰기</a>
